...
namespace Tweetbook.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<AuthenticationResult> RefreshTokenAsync(string token, string refreskToken)
        {
            ...
            var storedRefreshToken = await _context.RefreshTokens.SingleOrDefaultAsync(x => x.Token == refreskToken);
            ...
            if (storedRefreshToken.JwtId != jti)
                return new AuthenticationResult
                {
                    Errors = new[] { "This refresh token doenot match this JWT" }
                };
